...
const INITIAL: FranchisePartnerDetail[] = [
  {
    ...
    ledger: [
      ...
      },
      {
        ...
        title: '学具采购 · 人工智能 Micro:bit 编程学具',
        amount: -1490,
    ...
    classes: [
      { id: 'cls-1', name: '周六上午 · AI启蒙体验班', studentCount: 12, offlineDone: 2, offlineTotal: 6 },
      { id: 'cls-2', name: '暑期 · AI竞赛冲刺班', studentCount: 8, offlineDone: 3, offlineTotal: 8 },
    ],
    ordersMonthCount: 24,
    totalSales: 186420.5,
  ...
  },
  {
    ...
    classes: [{ id: 'cls-bj1', name: '周三晚 · AI编程基础班', studentCount: 15, offlineDone: 1, offlineTotal: 5 }],
    ordersMonthCount: 6,
    totalSales: 45200,
